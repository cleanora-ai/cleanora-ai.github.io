...
const steps = [
  ...
  { icon: Cpu, step: "02", title: "Classify Locally", desc: "Cleanora reviews filenames, extensions, dates, and metadata on your device." },
  { icon: Eye, step: "03", title: "Preview Suggestions", desc: "Inspect categories, destinations, and conflicts before anything changes." },
  { icon: Sparkles, step: "04", title: "Apply Approved Changes", desc: "Move files only after the exact plan fits how you browse them." },
];
